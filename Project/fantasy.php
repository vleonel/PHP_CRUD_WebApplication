<?php
  ...
  $sql = 'SELECT * FROM book WHERE Genre = "Fantasy" ORDER BY Title ASC';
   ...
   <div class ="row">
    <div class ="bookimage col-lg-1">
      ...
      <ul>
        ...
        <li> <?= $row['PubDate'] ?> </li>
        <li> <?= $row['Genre'] ?> </li>
        <!-- <input type="submit" name="command" value="Delete" onclick="return confirm('Do you want to delete the book's image?')" > -->
      </ul>
    </div>
  </div>
    <?php endwhile ?>
